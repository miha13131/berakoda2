...
public class Function
{
    ...
    public Function(IAmazonDynamoDB dynamoDb, string reservationsTable = "Reservations", string customerReservationsIndex = "CustomerReservationsIndex")
    {
        _dynamoDb = dynamoDb;
        _reservationsTable = reservationsTable;
        _customerReservationsIndex = customerReservationsIndex;
    }
